...
void drawThings() {
	...
	pool3 = new HDrawablePool(80); //tris
	pool3.autoAddToStage()

		.add (new HShape("svg1.svg").anchorAt(H.CENTER))
		.add (new HShape("svg2.svg").anchorAt(H.CENTER))
		.add (new HShape("svg3.svg").anchorAt(H.CENTER))
		.add (new HShape("svg4.svg").anchorAt(H.CENTER))
	...
	pool = new HDrawablePool(400); //tech
	pool.autoAddToStage()
