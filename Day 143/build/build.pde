...
void setup(){
	...
	canvas = (HCanvas) H.add(new HCanvas(P3D).autoClear(true).background(#010103));
	H.add(canvas);
	...
	layout = new HPolarLayout(1, 16, width / 2, height / 2, true, 02);
	...
	pool = new HDrawablePool(602); //Hex pattern
	// pool.autoAddToStage()
