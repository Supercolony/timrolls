...
void setup(){
	...
	H.init(this).use3D(true).background(255);
	smooth(8);
	...
	pool.autoParent(canvas)
		...
		.add (new HShape("vault1.svg").enableStyle(false))
		.add (new HShape("vault2.svg").enableStyle(false))
		.add (new HShape("vault3.svg").enableStyle(false))
		.add (new HShape("vault4.svg").enableStyle(false))
		.add (new HShape("vault5.svg").enableStyle(false))
				
		.add ( new HPath().polygon(3) )
		.add ( new HRect(2).width(200) )
		...
		.onCreate(
			new HCallback() {
				public void run(Object obj) {
					...
					pcolors2.applyColor(d).alpha(50);
	...
	pool4.autoParent(canvas)
		...
		.add( new HPath().polygon(3) )
		// .add( new HEllipse(5) )
		// .add (new HShape("spermy1.svg").enableStyle(false))
		// .add (new HShape("spermy2.svg").enableStyle(false))
		// .add (new HShape("spermy3.svg").enableStyle(false))
		// .add (new HShape("spermy4.svg").enableStyle(false))		
		// .add (new HShape("spermy5.svg").enableStyle(false))
		// .add (new HShape("peeta1.svg").enableStyle(false))
		// .add (new HShape("peeta2.svg").enableStyle(false))
		// .add (new HShape("peeta3.svg").enableStyle(false))
		// .add (new HShape("peeta4.svg").enableStyle(false))
		// .add (new HShape("peeta5.svg").enableStyle(false))
		...
		.add ( new HRect(5).width(1).height(random(100, 300)), 3 )
...
void draw() {
  ...
  for(Hand hand : leap.getHands()){
    ...
    float   sphere_radius    = hand.getSphereRadius();
        ...
        pcolors2.applyColor(poly).alpha(50);   
   	
   	for (HDrawable temp : pool4) {
		HDrawable d = (HDrawable) temp;
		int i = pool4.currentIndex();
		
			pcolors2.applyColor(d).alpha((int)hand_stabilized.z);
			// colorField.applyColor(d);
			if(hand_is_left){   
