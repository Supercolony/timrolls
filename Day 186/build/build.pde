...
void setup(){
	...
	H.init(this).use3D(true).background(#035948);
	smooth(8);
	...
	pool = new HDrawablePool(15); //Shapes
	pool.autoAddToStage()
	// pool.autoParent(canvas)
		...
		.add (new HShape("wisp.svg").enableStyle(false),4)
		.add (new HShape("wisp2.svg").enableStyle(false),4)
