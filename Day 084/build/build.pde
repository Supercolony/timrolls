...
void setup() {
	size(1000,1000);
	H.init(this).background(#0b080f).autoClear(true);
	smooth();
	...
	HImage hitObj3 = new HImage("wirecougar.png");
	H.add(hitObj3).anchorAt(H.CENTER).locAt(H.CENTER).size(1700).visibility(false);
...
void drawThings() {
	...
	// pool = new HDrawablePool(160); //top shapes
	// pool.autoAddToStage()

	// 	.add (new HShape("cyborg1.svg").anchorAt(H.CENTER))
	// 	.add (new HShape("cyborg2.svg").anchorAt(H.CENTER),4)
	// 	.add (new HShape("cyborg3.svg").anchorAt(H.CENTER),3)
	// 	.add (new HShape("cyborg4.svg").anchorAt(H.CENTER),2)
	// 	.add (new HShape("cyborg5.svg").anchorAt(H.CENTER),4)
