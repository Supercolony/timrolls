...
void setup(){
	...
	canvas = (HCanvas) H.add(new HCanvas(P3D).background(#000000).autoClear(false).fade(3));
	H.add(canvas);

	HImage BG = new HImage("BG.jpg");
	H.add(BG).anchorAt(H.CENTER).locAt(H.CENTER).size(1500);
