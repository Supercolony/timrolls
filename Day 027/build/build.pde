...
void setup() {
	...
	HImage hitObj2 = new HImage("stripes.png");
	...
	// hsl4 = new HShapeLayout().target(hitObj4);
 	...
 	pcolors= new HPixelColorist("mycop.jpg")
	.fillOnly()
	// .strokeOnly()
	// .fillAndStroke()
	;
...
void drawThings() {
	...
	pool4 = new HDrawablePool(200); // bg
	...
	pool3 = new HDrawablePool(500); // body
	pool3.autoAddToStage()


		.add (new HShape("stroke1.svg").anchorAt(H.CENTER))
		.add (new HShape("stroke2.svg").anchorAt(H.CENTER))
		.add (new HShape("stroke3.svg").anchorAt(H.CENTER),2)
		.add (new HShape("stroke4.svg").anchorAt(H.CENTER),2)
