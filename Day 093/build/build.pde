...
void setup(){
	...
	HImage hitObj2 = new HImage("redsword-layout.png");
...
void drawThings() {
	...
	pool3 = new HDrawablePool(400); // neck
	...
	pool = new HDrawablePool(100); //eyes
	pool.autoAddToStage()
			...
			new HCallback() {
				public void run(Object obj) {
					...
					d
						...
						.size( ( (int)random(3) * 80 ) ) // 50, 100, 150, 200
					;
					d.randomColors(colors.fillOnly());
				}
			}
	...
	s1 = new HShape("redsword.svg"); //top hair
	H.add(s1)
		 .scale(1.1f)
		// .strokeWeight(3)
		// .fill(#111111)
