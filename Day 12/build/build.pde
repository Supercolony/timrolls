...
void setup() {
	...
	HImage hitObj = new HImage("Sexy.png");
	H.add(hitObj).anchorAt(H.CENTER).locAt(H.CENTER).visibility(false).size(1200);
...
void drawThings() {
	...
	pool = new HDrawablePool(400); // Colorful flowers
	pool.autoAddToStage()

		.add (new HShape("splatters.svg"))
		.add (new HShape("splatters2.svg"))
		.add (new HShape("splatters3.svg"),4)
		.add (new HShape("splatters4.svg"),2)
