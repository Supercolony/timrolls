...
void setup(){
	...
	canvas = (HCanvas) H.add(new HCanvas().background(#051b36).autoClear(false));
	H.add(canvas);
	...
	pcolors2= new HPixelColorist("colors.png")
	// .fillOnly()
	// .strokeOnly()
	.fillAndStroke()
	;
		...
		.onCreate(
			new HCallback() {
				public void run(Object obj) {
					...
					pcolors2.applyColor(d).alpha(20);
...
void draw() {
  ...
  for(Hand hand : leap.getHands()){
    ...
    float   sphere_radius    = hand.getSphereRadius();
        ...
        pcolors2.applyColor(poly).alpha(20);   
