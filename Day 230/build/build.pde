...
String imgFileName = "leaves";
String fileType = "jpg";

int loops = 5;

int blackValue = -6700000; //Threshold for black mode
int brigthnessValue = 56; //Threshold for brightness mode
int whiteValue = -6000005; //Threshold for white mode

int warp = 894821266; //experimental value
