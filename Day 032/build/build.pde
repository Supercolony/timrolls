...
void setup() {
	size(1200,1200);
	H.init(this).background(#94c2d1).autoClear(true);
	smooth();
...
void drawThings() {
	...
	pool3 = new HDrawablePool(150); //back diamonds
	...
	pool = new HDrawablePool(21); //arabesques
	pool.autoAddToStage()

		.add (new HShape("goldleaf1.svg").anchorAt(H.CENTER))
		.add (new HShape("goldleaf2.svg").anchorAt(H.CENTER))
		.add (new HShape("goldleaf3.svg").anchorAt(H.CENTER))
		.add (new HShape("goldleaf4.svg").anchorAt(H.CENTER))
		.add (new HShape("goldleaf5.svg").anchorAt(H.CENTER))
		.add (new HShape("goldleaf6.svg").anchorAt(H.CENTER))
		.add (new HShape("goldleaf7.svg").anchorAt(H.CENTER))
	...
	pool5 = new HDrawablePool(7); //big diamonds
	...
	pool3 = new HDrawablePool(27); //colored diamonds
	pool3.autoAddToStage()
