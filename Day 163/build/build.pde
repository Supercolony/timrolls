...
void setup(){
	...
	pool.autoParent(canvas)
		...
		// .add (new HShape("flower1.svg").enableStyle(false))
		.add (new HShape("flower2.svg").enableStyle(false))
		.add (new HShape("flower3.svg").enableStyle(false))
		.add (new HShape("flower4.svg").enableStyle(false))
		.add (new HShape("flower5.svg").enableStyle(false))
		// .add (new HShape("flower6.svg").enableStyle(false))	
		.add (new HShape("flower7.svg").enableStyle(false))							
	...
	pool4.autoParent(canvas)
		// .add( new HPath() )
		.add( new HEllipse(5) )
		.add (new HShape("flower.svg").enableStyle(false),3)
		.add (new HShape("flower4.svg").enableStyle(false),3)
