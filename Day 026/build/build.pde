...
void setup() {
	...
	HImage hitObj2 = new HImage("deer.png");
	H.add(hitObj2).anchorAt(H.CENTER).locAt(H.CENTER).size(1200).visibility(false);
	hsl2 = new HShapeLayout().target(hitObj2);

	HImage hitObj3 = new HImage("deer2.png");
	...
	// hsl4 = new HShapeLayout().target(hitObj4);
 	...
 	pcolors= new HPixelColorist("sunrise.jpg")
	.fillOnly()
	// .strokeOnly()
	// .fillAndStroke()
	;
...
void drawThings() {
	...
	pool4 = new HDrawablePool(350); // antlers
	...
	pool3 = new HDrawablePool(650); // body
	pool3.autoAddToStage()
