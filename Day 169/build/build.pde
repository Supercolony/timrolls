...
void setup(){
	...
	;
	 ...
	 poly= new HPath().polygon(6);
     canvas.add(poly.x(captureX).x(captureY).fill(0).stroke(255).anchorAt(H.CENTER));
...
void draw() {
  ...
  for(Hand hand : leap.getHands()){
    ...
    float   sphere_radius    = hand.getSphereRadius();
        ...
        pcolors.applyColor(poly).alpha(120);
        // colorField.applyColor(poly);  
